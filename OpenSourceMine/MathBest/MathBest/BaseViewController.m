...
- (void)viewDidAppear:(BOOL)animated
{
    ...
    if (self.createDate) {
        ...
        NSLog(@"%@ first frame cost: %.2f", NSStringFromClass([self class]), duration * 1000);
        self.createDate = nil;
    }
}
...
- (void)reloadData
{
    ...
    EntryDataModel *lastModel = self.models.lastObject;
    CGRect frame = [lastModel.button frame];
