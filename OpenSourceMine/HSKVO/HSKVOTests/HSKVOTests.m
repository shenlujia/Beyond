...
@interface HSKVOTests : XCTestCase

@end

@implementation HSKVOTests
...
- (void)testUnobserveAfterRelease
{
    {
        __weak id weakObject = nil;
        {
            KVOPerson *object = [[KVOPerson alloc] init];
            weakObject = object;
            
            [object.HSKVO observe:object
    ...
    
    {
        //        __weak id weakObject = nil;
        //        {
        //            KVOPerson *obj = [[KVOPerson alloc] init];
        //            weakObject = obj;
        //
        ////            [obj.KVOControllerNonRetaining observe:obj
        ////                                           keyPath:KVO_NAME_KEY
        ////                                           options:NSKeyValueObservingOptionNew
        ////                                             block:^(id observer, id object, NSDictionary *change) {
        ////
