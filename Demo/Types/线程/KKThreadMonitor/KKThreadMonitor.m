...
#define KK_THRESHOLD 5
static const int threadIncreaseThreshold = 10;

//线程数量超过KK_THRESHOLD，就会弹窗警告，并且控制台打印所有线程的堆栈；之后阈值每增加5条(45、50、55...)同样警告+打印堆栈；如果线程数量再次少于40条，阈值恢复到40
