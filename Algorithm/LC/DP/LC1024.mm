...
{
    {
        vector<vector<int>> v = {{0,4},{2,8}};
        NSParameterAssert(videoStitching(v,5) == 2);
    }
    {
        vector<vector<int>> v = {{0,1},{1,2}};
        NSParameterAssert(videoStitching(v, 5) == -1);
    }
    {
        vector<vector<int>> v = {{0,2},{4,6},{8,10},{1,9},{1,5},{5,9}};
        NSParameterAssert(videoStitching(v, 10) == 3);
    }
