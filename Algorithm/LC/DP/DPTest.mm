...
+ (void)run
{
    ...
    vector<int> v1 = {120, 121, 122, 123, 139, 152, 188, 198, 213, 221, 264, 279, 300, 309, 322, 338, 343};
    vector<int> v2 = {516, 523, 576, 646, 647, 650, 673, 688, 698, 712, 714, 718, 740, 746, 790, 813, 837};
